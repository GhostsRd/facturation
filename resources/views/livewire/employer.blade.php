            ...
            <div class="col-lg-12">
                ...
                <hr>
                    ...
                    @csrf
                        ...
                        <input type="text" id="nom" wire:model='nom' class="form-control-plaintext p-1 ps-2 w-100  hover mt-1 rounded-5 shadow-sm" placeholder="nom de l'employer" required>   

                        <label for="prerequis"  class="text-muted m-2">{{_('prenom *')}}</label>             
                        <input type="text" wire:model="prenom"  class="form-control-plaintext p-1 ps-2 w-100  hover mt-1 rounded-5 shadow-sm" placeholder="prenom de l'employer" required>        
                
                        <label for="prerequis"  class="text-muted m-2">{{_('Contact *')}}</label>             
                        <input type="text" wire:model="contact"  class="form-control-plaintext p-1 ps-2 w-100  hover mt-1 rounded-5 shadow-sm" placeholder="Contact de l'employer" required>        
