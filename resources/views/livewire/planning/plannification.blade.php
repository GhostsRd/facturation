<div>
    ...
    <div class="shadow-sm p-4 container rounded-3 bg-white">
      ...
      {{-- <hr class="col-lg-5 offset-lg-3 col-5"> --}}
        ...
        <div class=" border border-warning p-2 rounded-2 col-lg-4">
                ...
                <div class="p-2 " >
                    <ul>
                        <li class="nav-item dropdown" style="list-style: none;font-size:0.7rem">
                            <a id="navbarDropdown" class="fw-bold dropdown-toggle border border-info bg-none text-dark bg-white p-2  rounded-3 text-center  nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                ...
                                <svg width="15" viewBox="0 0 24 24" class="animated-rotate icon-24 text-info" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <div class="dropdown-menu dropdown-menu-end bg-white text-center border-0 " aria-labelledby="navbarDropdown" style="cursor: pointer">
                        ...
                        <th rowspan="" class="border fw-bold w-100" style="background:rgba(209, 221, 225, 0.097); font-size:0.6rem">{{$item->designation}} : {{$it->date_debut + 1}} au {{$it->date_debut + $it->duree }} Jour </th>
                            ...
                            <td title="{{$item->designation}}"  colspan="{{$it->duree / 5}}" class="border-0  bg-white " style="font-size: 0.8rem;padding-left:0;height:0.7px" wire:click="modal('{{$item->id}}','{{$item->designation}}')" >
                                <div data-aos="fade-right" data-aos-delay="800" class=" pl-0 progress-bar text-center border-0 fw-bold text-white  rounded-end-4 shadow-sm   {{$sec->couleur}}" data-toggle="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" 
                                    style="width: 100%;height:100%; transition: width s ease 0s;"></div>
                            </td>
                            @endif
                    </tr>
