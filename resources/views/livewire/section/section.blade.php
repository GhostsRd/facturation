<div>
            ...
            <div class="container   p-2 rounded-2" style="font-size: 0.75rem">
              <form wire:submit.prevent="deleteSelected">
                  ...
                  <div class="row  p-2">
                      <div class="col-lg-2">
                          <h5 id="titre-prof" class="m-1 fw-bold">Liste de Séction</h5>
                      </div>
        ...
        <div id="modal" class="form shadow w-25  {{$form}}" method="POST">
          ...
          <div class="col-lg-12">
              <h5 class="fw-bold title-form text-center" >Ajouter un section</h5>
              <hr>
                  <form wire:submit.prevent="create">
                  @csrf

                      <label for="projet" class="text-muted m-2 " >{{_('Désignation  *')}}</label>
                      ...
                      <input type="text" wire:model="commentaire" 
                       ...
                       <label for="prerequis"  class="text-muted m-2">{{_('Couleur ')}}</label>        
           ...
           <form method="POST" action="{{url('/section/update')}}">
                  ...
                  {{-- {{dd($data)}} --}}
                    @csrf
                          ...
                          <label for="projet" class="text-muted m-2 " >{{_('designation  *')}}</label>
                          ...
                          <label for="contact"  class="text-muted m-2">{{_('Couleur *')}}</label>             
